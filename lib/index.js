...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log((_b = res === null || res === void 0 ? void 0 : res.data) === null || _b === void 0 ? void 0 : _b.sheets);
    const sheetProps = ((_c = res === null || res === void 0 ? void 0 : res.data) === null || _c === void 0 ? void 0 : _c.sheets) === undefined
        ? []
        : res.data.sheets.map((s) => { var _a, _b; return (((_a = s.properties) === null || _a === void 0 ? void 0 : _a.title) && ((_b = s.properties) === null || _b === void 0 ? void 0 : _b.sheetId) !== undefined ? { title: s.properties.title, id: s.properties.sheetId } : undefined); }).filter((prop) => prop !== undefined);
    const all = [];
